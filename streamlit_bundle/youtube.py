...
def extract_audio_with_ffmpeg(input_path, output_path, quality='standard'):
    ...
    try:
        ...
        is_streamlit_cloud = os.environ.get('STREAMLIT_SERVER_HEADLESS', 'false').lower() == 'true' or 'streamlit.app' in os.environ.get('STREAMLIT_SERVER_BASE_URL', '')
        ...
        if not shutil.which('ffmpeg'):
            ...
            # Tenta instalar FFmpeg automaticamente (apenas para Windows local)
            try:
                import platform
                    ...
                    try:
                        ...
                        if result.returncode == 0:
                            ...
                            if result.returncode == 0:
                                ...
                                st.info("🔄 Scoop falhou, tentando scoop...")
                                ...
                                if result.returncode == 0:
                                    ...
                                    try:
                                        ...
                                        raise Exception("Todas as opções de instalação falharam")
